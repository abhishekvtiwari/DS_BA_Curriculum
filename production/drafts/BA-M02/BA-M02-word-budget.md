...
| BA-02-C02 - Interviews | 7 | Approximately 10,000 | APPROVED - DRAFTED AT 7,862 |
...
This file authorizes the Phase 1 theory budget only. It does not authorize MCQs, assignments, practical procedures, labs, guided projects, case studies, capstones, or release work. Phase 1 begins with `BA-02-C01` only after the `BA-M01` prerequisite review passes.
