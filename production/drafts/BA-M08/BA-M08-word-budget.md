...
The first complete BA-M08 Phase 1 draft contains approximately 5,268 words. The chapter allocations are planning ceilings, not minimum completion targets. `ISS-001` and `ISS-007` remain open.
