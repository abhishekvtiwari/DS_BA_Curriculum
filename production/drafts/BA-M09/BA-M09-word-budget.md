...
The first complete BA-M09 Phase 1 draft contains approximately 5,976 words. The chapter allocations are planning ceilings, not minimum completion targets. `ISS-001` and `ISS-007` remain open.
